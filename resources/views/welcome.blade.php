                            ...
                            <div class="col-md-6">
                                                ...
                                                <li>
                                                    <a href="#">
                                                        <img class="contacts-list-img"
                                                             src="{{ asset('img/user1-128x128.jpg') }}" alt="">
                              ...
                              <span class="contacts-list-name">
                                ...
                                <small class="contacts-list-date float-right">2/23/2015</small>
                                                ...
                                                <li>
                                                    <a href="#">
                                                        <img class="contacts-list-img" src="{{ asset('img/user3-128x128.jpg') }}" alt="">
                              ...
                              <span class="contacts-list-name">
                                ...
                                <small class="contacts-list-date float-right">2/20/2015</small>
                                                ...
                                                <li>
                                                    <a href="#">
                                                        <img class="contacts-list-img" src="{{ asset('img/user5-128x128.jpg') }}" alt="">
                              ...
                              <span class="contacts-list-name">
                                ...
                                <small class="contacts-list-date float-right">2/10/2015</small>
                                                ...
                                                <li>
                                                    <a href="#">
                                                        <img class="contacts-list-img" src="{{ asset('img/user6-128x128.jpg') }}" alt="">
                              ...
                              <span class="contacts-list-name">
                                ...
                                <small class="contacts-list-date float-right">1/27/2015</small>
                                                ...
                                                <li>
                                                    <a href="#">
                                                        <img class="contacts-list-img" src="{{ asset('img/user8-128x128.jpg') }}" alt="">
...
<!-- PAGE PLUGINS -->
<!-- jQuery Mapael -->
<script src="{{ asset('node_modules/jquery-mousewheel/jquery.mousewheel.js') }}"></script>
<script src="{{ asset('node_modules/raphael/raphael.min.js') }}"></script>
<script src="{{ asset('node_modules/jquery-mapael/js/jquery.mapael.min.js') }}"></script>
<script src="{{ asset('node_modules/jquery-mapael/js/maps/usa_states.min.js') }}"></script>
<!-- ChartJS -->
